...
var TITLE = ['Дивный дворец', 'Чудесная квартирка', 'Милый дом', 'Уютное бунгало'];
...
var similarMapPin = mapPin.querySelector('#pin')
...
var getInformArrow = function () {
  var informarrow = [{
    author: getRandomArrElement(AVATAR),
    offer: {
...
var renderMapPin = function (informarrow) {
  ...
  mapPinElement.querySelector('img').src = informarrow.author;
  mapPinElement.querySelector('img').alt = informarrow.offer.title;
  mapPinElement.style = 'top: informarrow.location(y); left: ininformarrow.location(y)';
